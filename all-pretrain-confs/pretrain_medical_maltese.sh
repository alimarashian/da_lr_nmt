...
MODEL_TYPE=pretrained_liu_maltese_medical
TGT_LANG=ml_XX
IS_LECA=false
DICTIONARY_PATH_PRE=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Maltese/medical/en-ml-medical-merged.txt
