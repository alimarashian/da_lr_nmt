...
MODEL_TYPE=pretrained_loredat_croatian_news-dummy
TGT_LANG=hr_XX
IS_LECA=false
DICTIONARY_PATH_PRE=/projects/sema4648/mb_fairseq/data/news/Croatian/extracted_glossary_croatian.txt
...
POISSON_L=3.5
POST_MBART_NOISE_FUNCTION=ours
