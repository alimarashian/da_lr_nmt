...
MODEL_TYPE=pretrained_liu_icelandic_news
TGT_LANG=is_XX
IS_LECA=false
DICTIONARY_PATH_PRE=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Icelandic/news/en-is-news-merged.txt
