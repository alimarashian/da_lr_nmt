...
MODEL_TYPE=pretrained_liu_icelandic_news_just_testing
TGT_LANG=is_XX
IS_LECA=false
DICTIONARY_PATH_PRE=/projects/sema4648/mb_fairseq/data/news/Icelandic/extracted_glossary_icelandic.txt
