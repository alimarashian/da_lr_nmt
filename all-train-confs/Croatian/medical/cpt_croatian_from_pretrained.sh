...
MODEL_TYPE=just_bible_cpt_croatian_from_pretrained
TGT_LANG=hr_XX
IS_LECA=false
DICTIONARY_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Croatian/medical/hr-en-med-merged.txt
LEMMAS_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Croatian/medical/all_lemmas_Croatian_dictionary.txt
MAX_EPOCH=150
MIN_EPOCH=75
EARLY_STOPPING=true
PATIENCE=50
...
FROM_PRETRAINED_NAME=pretrained_liu_croatian_medical
