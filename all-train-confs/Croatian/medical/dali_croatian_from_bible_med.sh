...
MODEL_TYPE=dali_croatian_from_bible_med
TGT_LANG=hr_XX
IS_LECA=false
DICTIONARY_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Croatian/hr-en-med-merged.txt
LEMMAS_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Croatian/all_lemmas_Croatian_dictionary.txt
MAX_EPOCH=150
MIN_EPOCH=75
EARLY_STOPPING=true
PATIENCE=50
