...
MODEL_TYPE=just_bible_croatian_med
TGT_LANG=hr_XX
IS_LECA=false
DICTIONARY_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Icelandic/is-en-med-merged.txt ## this are basically placeholders when doing the basic mbart, so doesn't have to match
LEMMAS_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Icelandic/all_lemmas_icelandic_med.txt
MAX_EPOCH=150
MIN_EPOCH=75
EARLY_STOPPING=true
PATIENCE=50
...
FROM_PRETRAINED_NAME=just_bible_croatian
