...
MODEL_TYPE=just_bible_cpt_croatian_from_pretrained_news
TGT_LANG=hr_XX
IS_LECA=false
DICTIONARY_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Croatian/news/en-hr-news-merged.txt
LEMMAS_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Croatian/news/all_lemmas_Croatian_dictionary_news.txt
MAX_EPOCH=150
MIN_EPOCH=75
EARLY_STOPPING=true
PATIENCE=50
...
FROM_PRETRAINED_NAME=pretrained_liu_croatian_news
