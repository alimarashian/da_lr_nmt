...
MODEL_TYPE=just_bible_cpt_maltese_from_pretrained_medical
TGT_LANG=ml_XX
IS_LECA=false
DICTIONARY_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Maltese/medical/en-ml-medical-merged.txt
LEMMAS_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Maltese/medical/all_lemmas_Maltese_dictionary_medical.txt
MAX_EPOCH=150
MIN_EPOCH=75
EARLY_STOPPING=true
PATIENCE=50
...
FROM_PRETRAINED_NAME=pretrained_liu_maltese_medical
