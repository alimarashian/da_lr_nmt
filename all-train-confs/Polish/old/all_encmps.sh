...
MODEL_TYPE=psuedo_basic_mbart_bleu
TGT_LANG=pl_XX
IS_LECA=false
...
PATIENCE=-1
WARMUP_UPDATES=2000
TOTAL_NUM_UPDATES=95000 ### total-num-update is more than the steps for 100 epochs, but need to change it everytime (the first epoch had 305 iter so i went with this estimate for 100). Will have to check first and change it manually everytime :((
DOMAIN=news
