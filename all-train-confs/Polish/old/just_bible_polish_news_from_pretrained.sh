...
MODEL_TYPE=just_bible_polish_news_from_pretrained
TGT_LANG=pl_XX
IS_LECA=false
DICTIONARY_PATH=/projects/sema4648/mb_fairseq/data/news/Polish/dictionary/extracted_glossary_from_english.txt ## only if using the leca based systems that use dictionaries for suggestions
