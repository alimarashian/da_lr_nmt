...
MODEL_TYPE=cpt_news_from_pretrained_ukrainian
TGT_LANG=uk_XX
IS_LECA=false
DICTIONARY_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Ukrainian/uk-en-news-merged.txt
LEMMAS_PATH=/projects/sema4648/mb_fairseq/mbart-bible/dictionaries/Ukrainian/all_lemmas_news_Ukrainian_dictionary.txt
MAX_EPOCH=150
MIN_EPOCH=75
EARLY_STOPPING=true
PATIENCE=50
...
FROM_PRETRAINED_NAME=pretrained_liu_ukrainian_news
